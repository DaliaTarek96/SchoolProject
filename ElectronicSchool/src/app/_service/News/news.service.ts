...
export class NewsService {
  ...
  baseUrl: string = "http://localhost:8082/admin/addNews";
  baseUrl2:string="http://localhost:8082/admin/allSchoolNews";
  baseUrl3:string="http://localhost:8082/admin/deleteNews";
   formData :any
