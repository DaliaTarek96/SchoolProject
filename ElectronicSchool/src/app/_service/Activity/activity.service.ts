...
export class ActivityService {
  ...
  baseUrl: string = "http://localhost:8082/activity/allActivity";
  baseUrl2:string="http://localhost:8082/activity/addActivity";
  baseUrl3:string="http://localhost:8082/activity/deletActivity";
  formData :any
